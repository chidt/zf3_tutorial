...
--
-- Host: 127.0.0.1
-- Generation Time: Feb 22, 2018 at 06:42 AM
...
(1, 'The  Military  Wives222', '1'),
(2, 'Adele', '21'),
(3, 'Bruce  Springsteen', 'Wrecking Ball (Deluxe)'),
(4, 'Lana  Del  Rey', 'Born  To  Die'),
(5, 'Gotye', 'Making  Mirrors'),
(7, 'Đàm VĨnh Hưng', 'Bài Thánh Ca Buồn'),
...
(158, 'aaa', 'Tinh yeu hoa gio'),
(159, 'Test1', 'Tinh yeu hoa gio'),
(160, 'Đan Trường', 'Mãi mãi một tình yêu'),
(161, 'Đan Trường', 'Mãi mãi một tình yêu'),
(162, 'ABC', 'Test'),
(163, 'abc', 'Test'),
(164, 'vvv', 'aaaaa'),
(165, 'kakaa', 'ABC'),
...
(171, 'aaaa', 'Tesss'),
(172, 'ghjkl;', 'fg'),
(173, 'hello to day is friday', 'Test to day');
...
(2, 'Blog #2222', 'Welcome to my second blog post'),
(3, 'Blog #3', 'Welcome to my third blog post'),
(4, 'Blog #4', 'Welcome to my fourth blog post'),
(5, 'Blog #5', 'Welcome to my fifth blog post'),
(6, 'Hello cô ba', 'Hello my name is Ba'),
(7, 'Em của ngày hôm qua', 'Là em của ngày hôm qua');
...
(1, 'chidt', '$2y$10$FDsHu.WWswQcqEf89/DFGeKpJ1Erz2TDgIKxEFKRxbOtmlWV5aSZ2', 'Đỗ Tiến Chí', 1);
